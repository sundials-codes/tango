...
def main():
    ...
    parser.add_argument('--maxiter', type=int, default=None,
                        help='max iteration value for stopping convergence lines')
    ...
    parser.add_argument('--refidx', type=int, default=0,
                        help='which output file (number) to base refine line on')
    ...
    parser.add_argument('--ithresh', type=float, default=1.0e-14,
                        help='threshold for stopping convergence reference lines')
    parser.add_argument('--cthresh', type=float, default=1.0e-8,
                        help='threshold for estimating 1st order convergence constant')
    ...
    for outfile in args.outfiles:
        ...
        if "kinsol" in fname[0]:
            ...
            if args.legend:
                ...
                legend = make_legend_label(args.legendinfo, method, alpha, beta, mAA, delayAA)
            else:
                legend = None
            ...
            if args.legend:
                ...
                legend = make_legend_label(args.legendinfo, method, alpha, beta)
            else:
                legend = None
        ...
        ax.semilogy(iters[:nrm_pltidx], nrm[:nrm_pltidx], nonpositive='clip', label=legend)
